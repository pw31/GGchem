...
*********************************************************************
      ...
      real*8 :: pi,bk,amu,a0,f0,sigma,Nf,alpha,ex,slog
      ...
      SS = SSin
      sigma = 0.d0
      Nf    = 5.d0                         ! fit for sigma=sigma(N)
      if (trim(species)=='C') sigma=1400.  ! erg/cm2 (Gail+1984)
      if (trim(species)=='W') sigma=3340.  ! erg/cm2 (R.Tran+2016)
      if (sigma==0.d0) then
