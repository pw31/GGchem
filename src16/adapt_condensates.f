...
***********************************************************************
     ...
     >                    dust_nel,dust_el,dust_nu
      ...
      real*8 :: yr,Myr,molm,molmass,stoich,val,muHgas,muHnow,const
      real*8 :: change
      integer :: i,imol,iraus,e,aIraus,aIIraus,j,verb,dk,it,stindex
      integer :: k,keyel,imax,dustst,mainit,Nchange
      ...
      do
        ...
        do e=1,NELEM
          if (elread==elnam(e)) then
            epsgas(e) = 10.d0**(val-12.d0)
            !print*,e,elnam(e),val,epsgas(e)
          endif
        enddo  
      enddo
 100  continue
